...
angular.module('jobWidget').component('jobWidget', {
  ...
  controller: function controller($window, $scope, $route, $mdDialog, Jobs, GoogleMap, $rootScope) {
    // favorite icon
    this.favorite = false;
...
angular.module('mapWidget').component('mapWidget', {
  ...
  controller: function controller($scope, $rootScope, GoogleMap) {
...
;
angular.module('app.dashboard', ['ngMaterial', 'profileWidget', 'newsWidget', 'calendarWidget', 'jobWidget', 'tasksWidget', 'emailToneWidget', 'mapWidget', 'chart.js']).controller('dashboardController', function dashboardController($scope, Companies, User, Jobs, Tasks, Tone) {
...
angular.module('app.services', []).factory('Companies', function ($http) {
  ...
  return {
    getLocationCode: function getLocationCode(address) {
    ...
    getAddress: function getAddress(latlngCode) {
